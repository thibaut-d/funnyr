...
Here we can deactivate rows full of zeros.
This is a clearly cheating as we prune the test set too.
This avoids to deal with perturbations on some algorithms.
